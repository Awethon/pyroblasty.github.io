var data = [
    ...
    [
        ...
        },
        {
			...
			tier: 2,
            ranks: 5,
            desc: "Наносит на #% больше урона по чемпионам, чье здоровте ниже 40% Здоровья.",
            rankInfo: [1, 2, 3, 4, 5],
        },
        {
            index: 11,
        ...
        },
        {
			...
			tier: 5,
            ranks: 1,
            desc: "Нанесение 30% от максимального здоровья вражеского чемпиона за 2 секунды дает 35% скорости передвижения на 3 секунды (10 секунд перезарядки).",
            rankInfo: [],
        },
        {
            index: 22,
			...
			tier: 5,
            ranks: 1,
            desc: "Каждая третья автоатака или заклинание по вражескому чемпиону наносит 10 урона за уровень + 20% дополнительной силы атаки и 10% силы заклинаний магическим уроном по врагам в области вокруг чемпиона по которому автоатаки или заклинания были сделаны (30 секунд перезарядки).",
            rankInfo: [],
        },
		{
            index: 23,
			...
			tier: 5,
            ranks: 1,
            desc: "Лечение и щиты на 10% сильнее. Щиты и лечение повышают сопротивление цели на 15% на 3 секунды (не действет при применении на себя).",
            rankInfo: [],
        },
    ],
	    // Resolve
    [
        ...
        },
        {
			...
			tier: 1,
            ranks: 1,
            desc: "+12 Скорости предвижения при движении по кустам или реке",
            rankInfo: [],
        },
        {
            index: 6,
        ...
        },
        {
			...
			tier: 2,
            ranks: 5,
            desc: "Добавляет +#% к прочности щитов и к исцелению on you (includes lifesteal and regeneration)",
        ...
        },
        {
			...
			tier: 5,
            ranks: 1,
            desc: "Каждые 4 секунды в бою автоатака по вражескому чемпиону крадет 3% от максимального здоровья вашего чемпиона (В 2 раза меньше для чемпионов дальнего боя).",
            rankInfo: [],
        },
        {
            index: 22,
        ...
        },
		{
			...
			tier: 5,
            ranks: 1,
            desc: "Уменьшение входящего урона на 4%. Когда вы находитесь недалеко от союзника этот бонус удваивается до 8%  урона, который получает ваш союзник, наносится вам вместо него (данный эффект не будет работать, если после поглощения урона у вас останется менее 15% здоровья)",
            rankInfo: [],
        },
    ]
];
