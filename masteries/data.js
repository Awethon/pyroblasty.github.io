var data = [
    ...
    [
        ...
        },
        {
			...
			tier: 5,
            ranks: 1,
            desc: "Критические удары исцеляют 15% от нанесенного урона и дают 20% скорости атаки на 4 секунды (2 секунды перезарядки).",
            rankInfo: [],
        },
        {
            index: 22,
        ...
        },
		{
			...
			tier: 5,
            ranks: 1,
            desc: "Атакующие заклинания наносят вражеским чемпионам 6 + 50% от дополнительной силы атаки и 20% от силы заклинаний магическим уроном за 3 секунды (Заклинания, наносящие урон по площади, и периодический урон нанесут половину этого урона за 1.5 секунды).",
            rankInfo: [],
        },
    ],
	// Cunning
    ...
    [
        ...
        },
		{
			...
			tier: 4,
            ranks: 5,
            desc: "+#% к Стойкости и к сопротивлению замедлению",
