var data = [
    ...
    [
        ...
        },
		{
			...
			tier: 5,
            ranks: 1,
            desc: "Уменьшение входящего урона на 4%. Когда вы находитесь недалеко от союзника этот бонус удваивается. 8% урона получаемого союзниками, наносится вам вместо них (данный эффект не сработает, если у вас останется менее 15% здоровья)",
            rankInfo: [],
        },
    ]
];
